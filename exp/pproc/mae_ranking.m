...
for dim_i = 1:length(dimensions)
  ...
  for m = 1:nSettings
    ...
    maeMatrix = cell2mat(aggMAE(rows, (aggMAE_nHeaderCols+1):aggMAE_nColsPerFunction:end));
  ...
  headerCols    = { 'settingNo', 'No_covered', 'avg_MAE', 'covrd_MAE', 'avg_rank', 'covrd_rank', 'covrd_funs' };
