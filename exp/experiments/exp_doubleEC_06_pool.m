exp_id = 'exp_doubleEC_06_pool';
exp_description = 'Surrogate CMA-ES model using double-trained EC with sd2 criterion and GPs with double population and constant OR=0.05; PreSampleSize=0.75';
...
modelParams = { ...
    ...
    'parameterSets', { struct( ...
		'trainsetType',       { 'parameters', 'allPoints', 'nearest', 'nearest' }, ...
		'trainRange',         { 0.99, 0.999, 0.999, 0.99 }, ...
		'trainsetSizeMax',    { 30, 30, 40, 50  }, ...
