exp_id = 'exp_doubleEC_MP_MAE_3';
exp_description = 'MP,10D, MAE, Copy of DTC_23 - Surrogate CMA-ES, fixed DTS 0.05 (merged code) with sd2, 2-10D, DTIterations={1}, PreSampleSize=0.75, criterion={sd2}, 2pop, noisy functions';
...
structure(1).trainsetType = 'nearest';
...
structure(2).covFcn = '{@covMaterniso, 3}';
structure(2).trainsetType = 'allPoints';
structure(2).trainRange = 1;
structure(2).trainsetSizeMax = '15*dim';
...
structure(3).covFcn = '{@covMaterniso, 3}';
structure(3).trainsetType = 'clustering';
structure(3).trainRange = 0.999;
structure(3).trainsetSizeMax = '20*dim';
...
structure(4).trainsetType = 'nearestToPopulation';
structure(4).trainRange = 1;
structure(4).trainsetSizeMax = '5*dim';
