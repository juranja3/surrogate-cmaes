exp_id = 'exp_doubleEC_24_noisy_pool';
exp_description = 'Surrogate CMA-ES, fixed DTS 0.05 (merged code) with sd2, 2-10D, DTIterations={1}, PreSampleSize=0.75, criterion={sd2}, 2pop, noisy functions, modelPool';
...
modelParams = { ...
    ...
    'parameterSets', { struct( ...
		'trainsetType',       { 'parameters', 'allPoints', 'nearest' }, ...
		'trainRange',         { 0.999, 0.999, 0.999 }, ...
		'trainsetSizeMax',    { '', '10*dim', '5*dim'  }, ...
