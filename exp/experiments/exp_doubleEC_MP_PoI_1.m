exp_id = 'exp_doubleEC_MP_PoI_1';
exp_description = 'MP, 2D, final_model_settings.m, Copy of DTC_23 - Surrogate CMA-ES, fixed DTS 0.05 (merged code) with sd2, 2-10D, DTIterations={1}, PreSampleSize=0.75, criterion={sd2}, 2pop, noisy functions';
...
structure(2).trainsetSizeMax = '5*dim';
...
structure(3).trainsetSizeMax = '10*dim';
...
structure(4).trainsetType = 'clustering';
structure(4).trainRange = 0.999;
structure(4).trainsetSizeMax = '20*dim';
...
structure(5).trainRange = 0.999;
structure(5).trainsetSizeMax = '5*dim';
