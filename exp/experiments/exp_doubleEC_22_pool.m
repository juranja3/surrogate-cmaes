exp_id = 'exp_doubleEC_22_pool';
exp_description = 'Surrogate CMA-ES, fixed DTS 0.05 (merged code) with sd2, DTIterations={1}, PreSampleSize=0.75, {sd2,expectedRank,fvalues} criterion, 2pop';
