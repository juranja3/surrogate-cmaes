exp_id = 'exp_doubleEC_MP_14';
exp_description = 'MP, version 13-24 - final_model_settings.m, Copy of DTC_23 - Surrogate CMA-ES, fixed DTS 0.05 (merged code) with sd2, 2-10D, DTIterations={1}, PreSampleSize=0.75, criterion={sd2}, 2pop, noisy functions';
