exp_id = 'exp_doubleEC_MP_08_noisy';
...
parameterSets(1).trainsetType = 'allPoints';
...
parameterSets(3).covFcn = '{@covMaterniso, 3}';
parameterSets(3).trainsetType = 'nearest';
parameterSets(3).trainRange = 1;
parameterSets(3).trainsetSizeMax = '10*dim';
...
parameterSets(4).trainsetType = 'nearest';
parameterSets(4).trainRange = 1;
parameterSets(4).trainsetSizeMax = '20*dim';
...
parameterSets(5).trainsetSizeMax = '20*dim';
...
parameterSets(6).covFcn = '{@covMaterniso, 3}';
parameterSets(6).trainsetType = 'clustering';
parameterSets(6).trainRange = 0.999;
...
parameterSets(7).covFcn = '{@covSEard}';
parameterSets(7).trainsetType = 'nearestToPopulation';
parameterSets(7).trainRange = 0.999;
parameterSets(7).trainsetSizeMax = '20*dim';
