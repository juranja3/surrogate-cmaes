exp_id = 'exp_doubleEC_MP_11_noisy';
...
parameterSets(2).trainsetType = 'nearest';
parameterSets(2).trainRange = 0.999;
parameterSets(2).trainsetSizeMax = '10*dim';
...
parameterSets(4).covFcn = '{@covMaterniso, 3}';
