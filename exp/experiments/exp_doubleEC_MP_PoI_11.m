exp_id = 'exp_doubleEC_MP_PoI_11';
exp_description = 'MP, 5D, noisy, final_model_settings.m, Copy of DTC_23 - Surrogate CMA-ES, fixed DTS 0.05 (merged code) with sd2, 2-10D, DTIterations={1}, PreSampleSize=0.75, criterion={sd2}, 2pop, noisy functions';
...
structure(3).covFcn = '{@covSEiso}';
structure(3).trainsetType = 'clustering';
...
structure(4).covFcn = '{@covMaterniso, 3}';
structure(4).trainsetType = 'nearest';
structure(4).trainRange = 1;
structure(4).trainsetSizeMax = '10*dim';
...
structure(5).trainsetType = 'nearest';
structure(5).trainRange = 1;
structure(5).trainsetSizeMax = '20*dim';
...
structure(6).covFcn = '{@covMaterniso, 3}';
structure(6).trainsetType = 'allPoints';
structure(6).trainRange = 1;
structure(6).trainsetSizeMax = '15*dim';
structure(6).meanFcn = 'meanConst';
structure(6).trainAlgorithm = 'fmincon';
structure(6).hyp.lik = -4.605170;
structure(6).hyp.cov = [-0.693147; 0.693147];
modelParams = { ...
    'retrainPeriod',      { 1 }, ...
    'bestModelSelection', { 'poimax' }, ...
    'predictionType',     { 'sd2' }, ...
    'useShift',           { false }, ...
    'normalizeY',         { true }, ...
