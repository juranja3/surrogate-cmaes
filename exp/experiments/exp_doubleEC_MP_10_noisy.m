exp_id = 'exp_doubleEC_MP_10_noisy';
exp_description = 'MP, 5D, MSE, Copy of DTC_23 - Surrogate CMA-ES, fixed DTS 0.05 (merged code) with sd2, 2-10D, DTIterations={1}, PreSampleSize=0.75, criterion={sd2}, 2pop, noisy functions';
...
parameterSets(4).trainsetSizeMax = '10*dim';
...
parameterSets(5).trainsetSizeMax = '10*dim';
parameterSets(5).meanFcn = 'meanLinear';
...
parameterSets(6).trainsetType = 'allPoints';
parameterSets(6).trainRange = 1;
parameterSets(6).trainsetSizeMax = '15*dim';
parameterSets(6).meanFcn = 'meanLinear';
