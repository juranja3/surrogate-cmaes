exp_id = 'exp_doubleEC_MP_PoI_2';
exp_description = 'MP, final_model_settings.m, Copy of DTC_23 - Surrogate CMA-ES, fixed DTS 0.05 (merged code) with sd2, 2-10D, DTIterations={1}, PreSampleSize=0.75, criterion={sd2}, 2pop, noisy functions';
...
structure(5).covFcn = '{@covMaterniso, 3}';
