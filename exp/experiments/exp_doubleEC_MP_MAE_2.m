exp_id = 'exp_doubleEC_MP_MAE_2';
exp_description = 'MP, 5D, MAE, Copy of DTC_23 - Surrogate CMA-ES, fixed DTS 0.05 (merged code) with sd2, 2-10D, DTIterations={1}, PreSampleSize=0.75, criterion={sd2}, 2pop, noisy functions';
...
structure(2).trainsetType = 'clustering';
structure(2).trainRange = 0.999;
structure(2).trainsetSizeMax = '20*dim';
