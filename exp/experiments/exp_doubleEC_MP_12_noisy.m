exp_id = 'exp_doubleEC_MP_12_noisy';
...
parameterSets(1).covFcn = '{@covMaterniso, 5}';
...
parameterSets(2).covFcn = '{@covMaterniso, 3}';
...
parameterSets(4).meanFcn = 'meanLinear';
parameterSets(4).trainAlgorithm = 'fmincon';
parameterSets(4).hyp.lik = -4.605170;
parameterSets(4).hyp.cov = [-0.693147; 0.693147];
parameterSets(5).covFcn = '{@covMaterniso, 5}';
parameterSets(5).trainsetType = 'nearestToPopulation';
parameterSets(5).trainRange = 1;
parameterSets(5).trainsetSizeMax = '5*dim';
...
parameterSets(6).trainsetType = 'nearestToPopulation';
parameterSets(6).trainRange = 1;
parameterSets(6).trainsetSizeMax = '20*dim';
