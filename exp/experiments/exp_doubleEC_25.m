...
modelParams = { ...
    ...
    'parameterSets', { struct( ...
      'covFcn',{'{@covSEiso}', '{@covSEard}', '{@covSEard}', '{@covSEiso}'},...
      'trainsetType', {'nearest', 'clustering', 'clustering', 'allPoints'},...
      'trainRange', {1, 1, 1, 0.999},...
      'trainsetSizeMax', {'20*dim', '5*dim', '10*dim', '20*dim'},...
